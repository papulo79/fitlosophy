...
```bash
kimi --prompt "Lee docs/roles/consultor-kimi.md. Estoy bloqueado en la Tarea N del plan. Síntoma: <salida de la validación>. Qué he intentado: <...>. Diagnostica y propón un arreglo concreto."
```
