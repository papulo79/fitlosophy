...
- **Headless (bucle autónomo):** el orquestador (OpenCode) te invoca con `claude -p "Lee docs/roles/revisor-claude.md y revisa el PR #N ..." --dangerously-skip-permissions --model claude-opus-4-8`.
